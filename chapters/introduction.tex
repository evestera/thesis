...
\begin{itemize}
  ...
  \item Support for thunks, i.e. lazy or delayed evaluation, of parts of the abstract syntax tree, and letting such thunks be made by compile-time meta-programming.
\end{itemize}
